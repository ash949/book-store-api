  ...
  [
    {
      ...
      context:
        "If posted object contains only 'name' property and contains a (1 <= length <= 30) string",
      data: { name: "comedy" }
    }
  ],
  [
  ...
  [
    {
      ...
      context:
        "If posted data contains 'name' property only and which has a (1 <= length <= 30) string",
    ...
    },
    {
      expectedStatusCode: 200,
      context:
        "If posted data contains 'name' property only and has the same data as the old 'name' value",
      data: { name: "comedy" }
    }
  ],
  [
